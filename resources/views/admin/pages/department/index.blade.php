...
<section class="content-header">
    <h1>
        @yield('title')
        <small><a href="{{route('department.create')}}" class="btn btn-success btn-xs btn-flat btn-sm" title="Create Department"><i class="fa fa-plus"></i> CREATE</a></small>
    </h1>
</section>
                        ...
                        <table id="example1" class="table table-striped table-bordered border gy-4 gs-4">
                            <thead>
                                <tr class="fw-bold fs-6">
                                    ...
                                    <th style="text-align: center;">Department Image</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"> <img src="{{url('public/images/department/'.$data->department_img)}}" alt="Image" style="width: 50px; height: 50px;"> </td>
                                    <td style="text-align: center;"><?php echo (substr(strip_tags($data->department_description),0,400)) ?></td>
                                    <td>
                                        <div class="tab-pane active" id="kt_builder_toolbar">
                                            <div class="row">
                                                <div class="col-lg-4 col-xl-6">
                                                    <form action="{{route('department.departmentstatuschanger','id='.$data->id) }}" name="sstc{{$data->id}}" id="sstc{{$data->id}}" method="post">
                                                        {{ csrf_field() }}
                                    ...
                                    <td>
                                        <a title="Edit Department" href="{{route('department.edit',$data->id)}}" class="btn btn-icon btn-circle btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
