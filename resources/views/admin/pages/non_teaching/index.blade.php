...
@section('title', 'List Non Teaching Stuff')
@section('content')
<style>
...
<section class="content-header">
    <h1>
        @yield('title')
        <small><a href="{{route('non-teaching.create')}}" class="btn btn-success btn-xs btn-flat btn-sm" title="Create Department"><i class="fa fa-plus"></i> CREATE</a></small>
    </h1>
</section>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example1" class="table table-striped table-bordered border gy-4 gs-4">
                            ...
                            <tbody>
                                <?php
                                    $i=1;
                                    $datas = DB::table('non_teachings')->get();
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><img src="{{url('public/images/stuff/non-teaching/'.$data->image)}}" style="height: 50px; width:50px;"> </td>
                                        ...
                                        <div class="tab-pane active" id="kt_builder_toolbar">
                                            <div class="row">
                                                <div class="col-lg-4 col-xl-6">
                                                    <form action="{{route('non-teaching.nonteachingstatuschanger','id='.$data->id) }}" name="sstc{{$data->id}}" id="sstc{{$data->id}}" method="post">
                                                        {{ csrf_field() }}
                                    ...
                                    <td>
                                        <a title="Edit Non Teaching" href="{{route('non-teaching.edit',$data->id)}}" class="btn btn-icon btn-circle btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
