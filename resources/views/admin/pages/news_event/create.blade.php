...
<section class="content-header">
    <h1>
        @yield('title')
        <small><a href="{{route('news-event.index')}}" class="btn btn-warning btn-flat btn-sm" title="Back"><i class="fa fa-plus"></i> BACK</a></small>
    </h1>
...
<section class="content">
    ...
    <form action="{{route('news-event.store')}}" onsubmit="btnDisable()" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <!--begin::Row-->
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="input-group mb-5">
                            <input type="text" class="form-control" name="title" value="" placeholder="News Title" required>
                        </div>
                        {{-- News Image --}}
